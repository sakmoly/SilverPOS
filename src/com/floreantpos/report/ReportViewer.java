...
public class ReportViewer extends JPanel {
	...
	private void initComponents() {
		...
		dpStartDate = UiUtil.getDefualtStartDateTime();
                

		lblToDate = new JLabel(com.floreantpos.POSConstants.END_DATE + ":");
		dpEndDate =UiUtil.getDefualtEndDateTime();
	...
	private void doRefreshReport(java.awt.event.ActionEvent evt) {
		...
		//Date toDate = dpEndDate.getDate();
                //LocalDateTime fromDate=dpStartDate.getDateTimePermissive();
                //LocalDateTime toDate=dpEndDate.getDateTimePermissive();
                Date fromDate = java.sql.Timestamp.valueOf(dpStartDate.getDateTimePermissive());
		Date toDate = java.sql.Timestamp.valueOf(dpEndDate.getDateTimePermissive());
                System.out.println("Start Date= "+dpStartDate.toStringPermissive());
                 System.out.println("End Date= "+dpEndDate.toStringPermissive());
