...
public class SalesReport extends Report {
	...
	public void refresh() throws Exception {
		...
		map.put("reportTime", ReportService.formatFullDate(LocalDateTime.now())); //$NON-NLS-1$
		map.put("dateRange", ReportService.formatFullDate(getStartDate()) + " to " + ReportService.formatFullDate(getEndDate())); //$NON-NLS-1$ //$NON-NLS-2$
	...
	public void createModels() {
                //Date date1 =Date.from(instant); // DateUtils.startOfDay(getStartDate());
                //Date date1=java.sql.Timestamp.valueOf( getStartDate() );
                Date date1= getStartDate();
		//Date date2 = Date.from(instant); //DateUtils.endOfDay(getEndDate());
                //Date date2=java.sql.Timestamp.valueOf( getEndDate() );
